      ...
      {(search || categoryId) ? (
        ...
        <div className="container mx-auto px-4 relative z-20 flex flex-col lg:flex-row items-center justify-between">
          <div className="lg:w-[65%] xl:w-[60%]">
            ...
            {/* Hero Trust Badges */}
            <div className="flex flex-wrap items-center mt-12 gap-y-6">
              ...
              <div className="flex items-center space-x-3">
                ...
                <div>
                  <h4 className="font-bold text-white text-[11px] uppercase tracking-wide">PREMIUM QUALITY</h4>
                  <p className="text-gray-400 text-[10px]">Trusted Products</p>
                </div>
              </div>

              <div className="hidden md:block h-8 w-px bg-gray-800 mx-6"></div>
              ...
              <div className="flex items-center space-x-3">
                ...
                <div>
                  <h4 className="font-bold text-white text-[11px] uppercase tracking-wide">WIDE RANGE</h4>
                  <p className="text-gray-400 text-[10px]">1000+ Products</p>
                </div>
              </div>
              ...
              <div className="flex items-center space-x-3">
                ...
                <div>
                  <h4 className="font-bold text-white text-[11px] uppercase tracking-wide">GLOBAL SUPPLY</h4>
                  <p className="text-gray-400 text-[10px]">Worldwide Delivery</p>
                </div>
              </div>
              ...
              <div className="flex items-center space-x-3">
                ...
                <div>
                  <h4 className="font-bold text-white text-[11px] uppercase tracking-wide">BEST PRICES</h4>
                  <p className="text-gray-400 text-[10px]">Competitive Rates</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="lg:hidden mt-10 w-full flex justify-center">
            <img src="/hero_image.png" alt="Industrial Tools" className="w-full max-w-lg object-contain drop-shadow-2xl" />
          </div>
        </div>
      </div>
        ...
        <div className="container mx-auto px-4 flex flex-col lg:flex-row items-center justify-between">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 py-8 w-full">
            <div className="flex items-center justify-center lg:justify-start space-x-4 border-b md:border-b-0 md:border-r border-border-gray pb-6 md:pb-0">
              ...
              <div>
                <h4 className="font-bold text-white text-lg uppercase tracking-wide">Bulk Orders</h4>
                <p className="text-safety-yellow font-semibold text-sm">SPECIAL DISCOUNTS</p>
                <p className="text-gray-400 text-xs mt-1">Get Best Rates for Bulk Orders</p>
              </div>
            </div>

            <div className="flex items-center justify-center lg:justify-start space-x-4 border-b md:border-b-0 md:border-r border-border-gray pb-6 md:pb-0 pl-0 md:pl-4">
              <div className="text-safety-yellow">
              ...
              <div>
                <h4 className="font-bold text-white text-lg uppercase tracking-wide">Fast & Reliable Delivery</h4>
                <p className="text-gray-400 text-xs mt-1">On Time, Every Time</p>
              </div>
            </div>
            ...
            <div className="flex items-center justify-center lg:justify-start space-x-4 border-b lg:border-b-0 lg:border-r border-border-gray pb-6 lg:pb-0 pl-0 lg:pl-4">
              ...
              <div>
                <h4 className="font-bold text-white text-lg uppercase tracking-wide">Customer Support</h4>
                <p className="text-safety-yellow font-bold text-sm">+92 333 3818933</p>
